        ...
        <div className='w-full flex justify-center items-center max-w-[1340px] pb-[100px]'>
          <div className='grid lg:grid-cols-2 lg:space-x-[60px] lg:px-[40px] mt-[100px] lg:space-y-0 space-y-[80px] mx-[16px] transition-transform transform duration-300'>
            <div className='flex flex-col space-y-8 '>
              ...
              <FadeIn delay={0.6}>
                <div
                  className='bg-white py-[4px] lg:py-[8px] border-[3px] border-neutral-300 rounded-md flex items-center justify-center space-x-[16px] px-[12px] xs:w-[80%] md:w-[66%] lg:w-[80%]'>
                  <FaLocationDot className='text-[#4066ff] text-[24px]' />
                  <input className='flex-1 outline-none border-none font-poppins h-[20px] text-xs'/>
